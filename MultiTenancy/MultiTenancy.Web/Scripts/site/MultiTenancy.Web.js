...
(function (MultiTenancy) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return MultiTenancy.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = MultiTenancy.BasicSamples || (MultiTenancy.BasicSamples = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
...
(function (MultiTenancy) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return MultiTenancy.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return MultiTenancy.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = MultiTenancy.BasicSamples || (MultiTenancy.BasicSamples = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
...
(function (MultiTenancy) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return MultiTenancy.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return MultiTenancy.StaticTextBlock; }], ['FromLocalText', function () { return MultiTenancy.StaticTextBlock; }], ['DisplayFieldValue', function () { return MultiTenancy.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = MultiTenancy.BasicSamples || (MultiTenancy.BasicSamples = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
...
(function (MultiTenancy) {
    ...
    })(Meeting = MultiTenancy.Meeting || (MultiTenancy.Meeting = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    var Meeting;
...
(function (MultiTenancy) {
    ...
    })(Organization = MultiTenancy.Organization || (MultiTenancy.Organization = {}));
})(MultiTenancy || (MultiTenancy = {}));
var MultiTenancy;
(function (MultiTenancy) {
    var Organization;
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                ...
                _this.form.ProductID.cascadeField = MultiTenancy.Northwind.ProductRow.Fields.CategoryID;
                return _this;
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = MultiTenancy.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = MultiTenancy.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, MultiTenancy.Northwind.OrderRow.Fields.ShipCountry);
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: MultiTenancy.Northwind.OrderRow.Fields.CustomerCompanyName,
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: MultiTenancy.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = MultiTenancy.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
